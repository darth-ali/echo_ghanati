...
<head>
    ...
    <!--=============== css  ===============-->
    <link type="text/css" rel="stylesheet" href="<?php echo ASSETS_URI ?>css/plugins.css">
    <link type="text/css" rel="stylesheet" href="<?php echo ASSETS_URI ?>css/style.css">
    <link type="text/css" rel="stylesheet" href="<?php echo ASSETS_URI ?>css/color.css">
    <!--=============== favicons ===============-->
    <link rel="shortcut icon" href="<?php echo ASSETS_URI ?>images/favicon.ico">
    <?php wp_head(); ?>
</head>
